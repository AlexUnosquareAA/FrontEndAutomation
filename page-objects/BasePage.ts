...
export abstract class BasePage {
   ...
   * @param locator - The element locator
   */
  async verifyElementNotVisible(locator: Locator): Promise<void> {
  ...
  async verifyCurrentUrl(expectedUrl: string | RegExp): Promise<void> {
   ...
   async verifyCurrentUrlDontExist(expectedUrl: string | RegExp): Promise<void> {
    await expect(this.page).not.toHaveURL(expectedUrl);
  }
